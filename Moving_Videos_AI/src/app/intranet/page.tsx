              ...
              {STEPS.map((s, i) => (
                <li key={s.id} className="flex items-center gap-2">
                  <button
                    ...
                    aria-label={`Paso ${i + 1} de ${STEPS.length}: ${s.label}${i === currentStepIndex ? " (actual)" : i < currentStepIndex ? " (completado)" : " (pendiente)"}`}
                    className={`flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 ${
                      i === currentStepIndex
      ...
      <div className="flex-1 mx-auto w-full max-w-5xl px-6 py-8">
        <AnimatePresence mode="wait">
          ...
          {step === "confirm" && (
            ...
            >
              <div className="text-center max-w-lg" aria-live="polite" aria-atomic="true">
                <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-2xl bg-primary/10 border border-primary/20" aria-hidden="true">
                ...
                <p className="mt-3 text-muted-foreground">
                  ...
                  <span className="text-foreground font-medium">
                    {selectedStyle ? DESIGN_STYLES[selectedStyle].label : ""}
                  </span>
